...
extension AndroidNotificationChannelMapper on AndroidNotificationChannel {
  Map<String, Object?> toMap() => <String, Object?>{
    ...
    'ledColorAlpha': ledColor?.intAlpha,
    'ledColorRed': ledColor?.intRed,
    'ledColorGreen': ledColor?.intGreen,
    'ledColorBlue': ledColor?.intBlue,
...
extension BigTexStyleInformationMapper on BigTextStyleInformation {
  Map<String, Object?> toMap() =>
      _convertDefaultStyleInformationToMap(this)..addAll(<String, Object?>{
        'bigText': bigText,
  ...
  Map<String, Object?> _convertStyleInformationToMap() {
    if (styleInformation is BigPictureStyleInformation) {
      ...
      return <String, Object?>{
        ...
        'styleInformation': (styleInformation as DefaultStyleInformation?)
            ?.toMap(),
      };
    } else {
      return <String, Object>{
      ...
      'actions': actions
          .map(
            (AndroidNotificationAction e) => <String, dynamic>{
              'id': e.id,
              'title': e.title,
              'titleColorAlpha': e.titleColor?.intAlpha,
              'titleColorRed': e.titleColor?.intRed,
              'titleColorGreen': e.titleColor?.intGreen,
              'titleColorBlue': e.titleColor?.intBlue,
